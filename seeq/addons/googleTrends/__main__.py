...
def cli_interface():
    ...
    parser = argparse.ArgumentParser(description='Install google-trends as a Seeq Add-on Tool')
    ...
    parser.add_argument('--app_url', type=str,
                        help="URL of google-trends app notebook with the format e.g. https://my.seeq.com/data-lab/CBA9A827-35A8-4944-8A74-EE7008DC3ED8/notebooks/hb/seeq/addons/google-trends/App.ipynb")
